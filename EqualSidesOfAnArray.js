...
/**
 * Fail work...
 * I wrote this by referring to other people's solutions on Python. It turned out that the method I came up with was much better.
 *  This solution works fine on python.
 */
// function findEvenIndex(arr) {
//   rightArr = [...arr];
//   leftSum = 0;
//   rightSum = rightArr.reduce((sum, i) => {
//     return sum + i;
//   });
